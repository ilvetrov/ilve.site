export function checkThatObjectIsInScrollArea(object, topOffset = 200, bottomOffset = topOffset) {
...
export function checkTopElementVisibility(element, offset = 0) {
...
export function checkElementVisibilityByScreenCenter(element) {
